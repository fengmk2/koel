<template>
  <ul>
    ...
    <MenuItem @click="toggleFavorite">{{
      artist.favorite ? "Undo Favorite" : "Favorite"
    }}</MenuItem>
...
const isStandardArtist = computed(
  () => !artistStore.isUnknown(artist.value) && !artistStore.isVarious(artist.value),
);
...
const requestEditForm = () =>
  trigger(() => openModal<"EDIT_ARTIST_FORM">(EditArtistForm, { artist: artist.value }));
