<template>
  <section id="mainContent" class="flex-1 relative overflow-hidden">
    ...
    <RecentlyPlayedScreen
      v-if="screenLoaded('RecentlyPlayed')"
      v-show="screen === 'RecentlyPlayed'"
    />
    ...
    <SearchExcerptsScreen
      v-if="screenLoaded('Search.Excerpt')"
      v-show="screen === 'Search.Excerpt'"
    />
    ...
    <RadioStationListScreen
      v-if="screenLoaded('Radio.Stations')"
      v-show="screen === 'Radio.Stations'"
    />
    <MediaBrowser
      v-if="useMediaBrowser && screenLoaded('MediaBrowser')"
      v-show="screen === 'MediaBrowser'"
    />
...
const AlbumListScreen = defineAsyncComponent(
  () => import("@/components/screens/AlbumListScreen.vue"),
);
const AlbumScreen = defineAsyncComponent(() => import("@/components/screens/AlbumScreen.vue"));
const AllSongsScreen = defineAsyncComponent(
  () => import("@/components/screens/AllSongsScreen.vue"),
);
const ArtistListScreen = defineAsyncComponent(
  () => import("@/components/screens/ArtistListScreen.vue"),
);
...
const FavoritesScreen = defineAsyncComponent(
  () => import("@/components/screens/FavoritesScreen.vue"),
);
const GenreListScreen = defineAsyncComponent(
  () => import("@/components/screens/GenreListScreen.vue"),
);
...
const MediaBrowser = defineAsyncComponent(
  () => import("@/components/screens/MediaBrowserScreen.vue"),
);
const NotFoundScreen = defineAsyncComponent(
  () => import("@/components/screens/NotFoundScreen.vue"),
);
const PlaylistScreen = defineAsyncComponent(
  () => import("@/components/screens/PlaylistScreen.vue"),
);
const PodcastListScreen = defineAsyncComponent(
  () => import("@/components/screens/PodcastListScreen.vue"),
);
...
const RadioStationListScreen = defineAsyncComponent(
  () => import("@/components/screens/RadioStationListScreen.vue"),
);
const RecentlyPlayedScreen = defineAsyncComponent(
  () => import("@/components/screens/RecentlyPlayedScreen.vue"),
);
const SearchExcerptsScreen = defineAsyncComponent(
  () => import("@/components/screens/search/SearchExcerptsScreen.vue"),
);
...
const SettingsScreen = defineAsyncComponent(
  () => import("@/components/screens/SettingsScreen.vue"),
);
const UploadScreen = defineAsyncComponent(() => import("@/components/screens/UploadScreen.vue"));
const UserListScreen = defineAsyncComponent(
  () => import("@/components/screens/UserListScreen.vue"),
);
const VisualizerScreen = defineAsyncComponent(
  () => import("@/components/screens/VisualizerScreen.vue"),
);
