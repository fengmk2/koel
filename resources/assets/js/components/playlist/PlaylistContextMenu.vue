  ...
  <ul>
    ...
    <MenuItem>
      ...
      <template #subMenuItems>
        ...
        <MenuItem v-if="canShowCollaboration" @click="showCollaborationModal"
          >Collaborate…</MenuItem
        >
      </template>
    </MenuItem>
...
const showCollaborationModal = () =>
  trigger(() =>
    openModal<"PLAYLIST_COLLABORATION">(PlaylistCollaborationModal, { playlist: playlist.value }),
  );
