...
const EditPlaylistFolderForm = defineAsyncComponent(
  () => import("@/components/playlist/EditPlaylistFolderForm.vue"),
);
...
const playlistsInFolder = computed(() =>
  folder.value ? playlistStore.byFolder(folder.value) : [],
);
...
const createPlaylist = () =>
  trigger(() =>
    openModal<"CREATE_PLAYLIST_FORM">(CreatePlaylistForm, { folder: folder.value!, playables: [] }),
  );
const createSmartPlaylist = () =>
  trigger(() =>
    openModal<"CREATE_SMART_PLAYLIST_FORM">(CreateSmartPlaylistForm, { folder: folder.value! }),
  );
const rename = () =>
  trigger(() =>
    openModal<"EDIT_PLAYLIST_FOLDER_FORM">(EditPlaylistFolderForm, { folder: folder.value! }),
  );
