  ...
  <ScreenBase :background-image="artist?.image || undefined">
    <template #header>
      ...
      <ScreenHeader
        v-if="artist"
        :disabled="loading"
        :layout="songs.length ? headerLayout : 'collapsed'"
      >
        {{ artist.name }}
...
const ArtistEventList = defineAsyncComponent(
  () => import("@/components/artist/ArtistEventList.vue"),
);
const AlbumCardSkeleton = defineAsyncComponent(
  () => import("@/components/ui/album-artist/ArtistAlbumCardSkeleton.vue"),
);
const FavoriteButton = defineAsyncComponent(() => import("@/components/ui/FavoriteButton.vue"));
const ArtistContextMenu = defineAsyncComponent(
  () => import("@/components/artist/ArtistContextMenu.vue"),
);
