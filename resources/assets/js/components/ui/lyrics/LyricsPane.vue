...
const LrcLyricsPane = defineAsyncComponent(
  () => import("@/components/ui/lyrics/LrcLyricsPane.vue"),
);
...
const showEditSongForm = () =>
  openModal<"EDIT_SONG_FORM">(EditSongForm, { songs: [song.value], initialTab: "lyrics" });
