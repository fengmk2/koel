<template>
  ...
  >
    ...
    />
    <span
      class="absolute top-0 left-0 w-full h-full group-hover:bg-black/40 no-hover:bg-black/40 z-10"
    />
    <span
    ...
    >
      <Icon
        v-if="playable.playback_state === 'Playing'"
        :icon="faPause"
        class="text-k-highlight-fg"
      />
