<template>
  <div class="space-y-6">
    <section v-if="!supported" class="text-k-fg-70">
      Offline playback is not supported in this browser.
    </section>
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-4">
            <div class="flex-1 h-2 bg-k-fg-10 rounded-full overflow-hidden">
              <div
                class="h-full bg-k-highlight rounded-full transition-all"
...
const { swReady, storageUsage, storageQuota, cachedSongCount, clearAllOfflineCache } =
  useOfflinePlayback();
